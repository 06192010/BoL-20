...
--
		...
		if rpos and rinfo.hitchance >= 1 and not coll:GetMinionCollision(rpos, myHero) then
...
--
		...
		if rpos and qpos and qinfo.hitchance >= 1 and not coll:GetMinionCollision(rpos, myHero) then
